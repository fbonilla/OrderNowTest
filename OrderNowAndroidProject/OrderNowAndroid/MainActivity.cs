...
namespace OrderNowAndroid
{
	...
	public class MainActivity : Activity
	{
		...
		private Fragment mInfosSection;
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			mLayoutInfos = Resource.Id.layoutInfosSection;
			...
			// Infos section Fragment
			mTransaction = this.FragmentManager.BeginTransaction ();
			mInfosSection = new InfosSectionFragment ();
			mTransaction.Add (mLayoutInfos, mInfosSection);
			mTransaction.Commit ();
		...
		public void NavigateToTabInfos()
		{
			ViewFlipper flippy = FindViewById<ViewFlipper> (Resource.Id.viewFlipper);
			while(flippy.CurrentView.Id != FindViewById<FrameLayout>(Resource.Id.layoutInfosSection).Id)
				flippy.ShowNext ();
			mCurrentView = flippy.CurrentView;
		}
	}
